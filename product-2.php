                    ...
                    <div class="col-lg-9 order-lg-3">
                        <div class="main-product">
                            <div class="main-product-title">
                                <h4>chuột máy tính</h4>
                            </div>

                            <div class="row main-product-top">
                                <div class="col d-lg-inline-block d-sm-none d-none">
                                    <div class="main-product-view ">
                                        <a title="Dạng lưới" class="view-product " href="product.php">
                                            <i class="fa fa-th-large" aria-hidden="true"></i>
                                        </a>

                                        <a title="Dạng danh sách" class="view-product active" href="product-2.php">
