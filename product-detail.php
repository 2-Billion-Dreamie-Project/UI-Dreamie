            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="product.php">Chuột máy tính</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Logitech G502 Proteus Spectrum</li>
                    </ol>
                </nav>
            </div>
        </section>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="product-detail-1-detail">
                                            ...
                                            <div class="quantity">
                                                ...
                                                <button class="quantity-wishlist"><i class="fa fa-heart" aria-hidden="true"></i></button>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="box-product-left">
                                            <div class="box-product-left-img">
                                                <a href="product-detail.php"><img src="public/img/product-1.png" alt=""></a>
                                            </div>
